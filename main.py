...
from langchain.agents.agent_toolkits import spark_sql
...
def get_vector_store(text_chunks):
    ...
    vector_store.save_local("faiss_index") #store entire vecotr in local
    #return vector_store
...
if __name__ == "__main__":
    ...
    #user_input("What is the purpose of the project?")
    #user_input("What is the purpose of the project?")
    #user_input("What is the purpose of the project?")
